  ...
  <div id="permission-add">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-sitemap"></i>&nbsp;&nbsp;Edit Permission</h3>
          </div>
          <div class="col-sm-6">
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/v1/permission/'+this.$route.params.permissionId).then((response)=>{
    ...
    methods:{
        updatePermission(){
            this.$Progress.start()
            this.form.put('api/v1/permission/'+this.$route.params.permissionId)
            .then((response)=>{
